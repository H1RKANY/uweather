...
const Page: PageEl = (props , state, refresh, getProps) => {
  ...
  return (
    <div style={{ direction: "ltr", minHeight: "11vh",}}>
      <br-x />
      <Window  style={{ minHeight: 200, marginLeft: 10, width: "calc(90% - 20px)" }}>

        <div style={{width:"100%", height:400 , backgroundColor:"#FFF" , textAlign:"left", backgroundImage:`url(${"/12.png"})`,borderRadius:10,backgroundSize:"10%"}}><img src="/" alt="" />
          
          <div style={{width:"35%", height:50, backgroundColor:"rgba(2 28 39 / 0.7)",borderRadius:20, marginTop:0 , marginLeft:230,fontSize:16, boxShadow:"3px 3px #061319" , color:"rgb(41 130 190)"}}>
            <div>
              <br />
          ...
          <br />
          <div style={{width:"55%", height:300, backgroundColor:"rgba(1 23 4 / 0.65)",borderRadius:20, marginLeft:160, textAlign:"center",boxShadow:"5px 5px #034969",color:"rgb(107 195 225)" }}>
            <br-xx />
